...
@implementation EKNavigationBar
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
    ...
    if (view && [viewName isEqualToString:@"EKNavigationBar"]) {
    ...
    NSArray *array = @[ @"UINavigationBarContentView", @"EKNavigationBar" ];
    if ([array containsObject:viewName]) {
